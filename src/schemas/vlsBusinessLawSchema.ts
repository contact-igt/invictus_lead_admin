...
export interface VlsBusinessLawFormValues {
  name: string;
  mobile: string;
  email: string;
  amount: string;
...
export const vlsBusinessLawInitialValues: VlsBusinessLawFormValues = {
  name: '',
  mobile: '',
  email: '',
  amount: '',
...
export const vlsBusinessLawSchema = Yup.object({
  name: Yup.string()
    .trim()
