...
const VlsTaxationLawTable = ({
  ...
  const columns: GridColDef<TableRow>[] = [
    ...
    },
    {
      ...
      renderCell: (params) => (
        <Typography variant="body2" fontWeight={650}>
          {formatVlsTaxationLawAmount(params.row.amount)}
        </Typography>
      ),
    },
    {
      ...
      renderCell: (params) => (
        <Typography variant="body2" color="text.secondary">
          {formatVlsTaxationLawDate(params.row.registered_date)}
        </Typography>
      ),
    },
    {
      ...
      renderCell: (params) => (
        <Typography variant="body2" color="text.secondary">
          {formatVlsTaxationLawDate(params.row.programm_date)}
        </Typography>
      ),
    },
    {
    ...
    },
    {
      ...
      renderCell: (params) => (
        <Typography variant="body2" color="text.secondary">
          {formatVlsTaxationLawDateTime(params.row.created_at)}
        </Typography>
      ),
    },
    {
      ...
      >
        ...
        <Typography variant="h6" mt={1.5}>
          {hasFilters
            ...
            : 'No Taxation Law registrations yet'}
        </Typography>
        {!hasFilters && (
