...
interface AaravEyeCareDeleteDialogProps {
  open: boolean;
...
const AaravEyeCareDeleteDialog = ({
  open,
  lead,
  isLoading,
  onClose,
  onConfirm,
}: AaravEyeCareDeleteDialogProps) => (
  <Dialog open={open} onClose={isLoading ? undefined : onClose} maxWidth="xs" fullWidth>
    ...
    <DialogContent>
      <DialogContentText>
        This will permanently delete the Aarav Eye Care lead for &quot;{lead?.name || 'this lead'}&quot;.
...
export default AaravEyeCareDeleteDialog;
