...
interface VlsBusinessLawDeleteDialogProps {
  open: boolean;
...
const VlsBusinessLawDeleteDialog = ({
  open,
  registration,
  isLoading,
  onClose,
  onConfirm,
}: VlsBusinessLawDeleteDialogProps) => (
  <Dialog open={open} onClose={isLoading ? undefined : onClose} maxWidth="xs" fullWidth>
    ...
    <DialogContent>
      <DialogContentText>
        This will permanently delete the Business Law registration for &quot;{registration?.name || 'this registration'}&quot;.
...
export default VlsBusinessLawDeleteDialog;
