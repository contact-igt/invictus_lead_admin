...
interface ShantiEyeTechDeleteDialogProps {
  open: boolean;
...
const ShantiEyeTechDeleteDialog = ({
  open,
  lead,
  isLoading,
  onClose,
  onConfirm,
}: ShantiEyeTechDeleteDialogProps) => (
  <Dialog open={open} onClose={isLoading ? undefined : onClose} maxWidth="xs" fullWidth>
    ...
    <DialogContent>
      <DialogContentText>
        This will permanently delete the Shanti Eye Tech lead for &quot;{lead?.name || 'this lead'}&quot;.
...
export default ShantiEyeTechDeleteDialog;
