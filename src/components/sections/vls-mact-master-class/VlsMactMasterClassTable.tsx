...
const VlsMactMasterClassTable = ({
  ...
  const columns: GridColDef<TableRow>[] = [
    ...
    },
    {
      ...
      renderCell: (params) => (
        <Typography variant="body2" fontWeight={650}>
          {formatVlsMactAmount(params.row.amount)}
        </Typography>
      ),
    },
    {
      ...
      renderCell: (params) => (
        <Typography variant="body2" color="text.secondary">
          {formatVlsMactDate(params.row.registered_date)}
        </Typography>
      ),
    },
    {
      ...
      renderCell: (params) => (
        <Typography variant="body2" color="text.secondary">
          {formatVlsMactDate(params.row.programm_date)}
        </Typography>
      ),
    },
    {
    ...
    },
    {
      ...
      renderCell: (params) => (
        <Typography variant="body2" color="text.secondary">
          {formatVlsMactDateTime(params.row.created_at)}
        </Typography>
      ),
    },
    {
      ...
      >
        ...
        <Typography variant="h6" mt={1.5}>
          {hasFilters
            ...
            : 'No MACT Master Class registrations yet'}
        </Typography>
        {!hasFilters && (
