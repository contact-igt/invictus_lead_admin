...
export default {
  ...
  enquiries: `/${rootPaths.pageRoot}/enquiries`,
  generalEnquiries: `/${rootPaths.pageRoot}/enquiries/general`,
  careersApplications: `/${rootPaths.pageRoot}/enquiries/careers`,
  publicForms: `/${rootPaths.pageRoot}/public-forms`,
