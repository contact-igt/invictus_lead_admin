...
const STATUS_COLORS: Record<string, { bg: string; fg: string }> = {
  ...
  missed: { bg: '#FEF2F2', fg: '#EF4444' },
  failed: { bg: '#FEF2F2', fg: '#EF4444' },
  no_answer: { bg: '#FFFBEB', fg: '#F59E0B' },
  busy: { bg: '#FFFBEB', fg: '#F59E0B' },
  in_progress: { bg: '#EFF6FF', fg: '#3B82F6' },
};
      ...
      <Box sx={{ bgcolor: '#FFFFFF', border: '1px solid', borderColor: CARD_BORDER, borderRadius: '14px', overflow: 'hidden' }}>
        {isLoading ? (
          ...
          calls.map((call, index) => {
            const statusColor = (call.status && STATUS_COLORS[call.status]) || { bg: '#F1F5F9', fg: TEXT_MUTED };
            ...
            return (
              <Stack
                ...
                sx={{
                  ...
                  '&:hover': clickable ? { bgcolor: 'rgba(15,23,42,0.02)' } : undefined,
