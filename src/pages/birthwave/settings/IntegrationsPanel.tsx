...
const STATUS_META: Record<CrmIntegrationStatus, { label: string; bg: string; fg: string }> = {
  not_configured: { label: 'Not Configured', bg: 'var(--bw-surface-2)', fg: TEXT_MUTED },
  connected: { label: 'Connected', bg: 'rgba(41,175,129,0.12)', fg: GREEN },
  error: { label: 'Error', bg: 'var(--bw-tint-red)', fg: '#EF4444' },
};
              ...
              >
                <Stack direction="row" alignItems="center" justifyContent="space-between" spacing={1.5}>
                  <Stack direction="row" alignItems="center" spacing={1.5} sx={{ minWidth: 0 }}>
                    <Box sx={{ width: 36, height: 36, borderRadius: '8px', bgcolor: 'var(--bw-surface-2)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
